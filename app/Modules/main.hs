...
-- Cadastrar Cliente
listaIngressosInicialCliente:: [Filme]
listaIngressosInicialCliente = []
...
cadastroClienteTela = do
   ...
   putStrLn ("\nDigite os salas do cliente: (Sem caracteres especiais)")
   ...
   let cliente = Cliente nomeCliente cpfCliente dataCadastro listaIngressosInicialCliente listaSalasCliente
...
-- Ingressor filme
ingressorDeFilmeTela :: IO ()
ingressorDeFilmeTela = do
   system "clear"
   ...
   putStrLn("\nA ingresso foi cadastrada com sucesso! Volte sempre!\n")

   escreverApenasIngressosCliente cpf listaFilmes
...
opcoesTelaVisualizarFilmes = ["Visualizar por sala", "Visualizar por existentes no estoque"]
